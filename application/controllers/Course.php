...
if($this->session->userdata('skill_user'))
	...
	{	
		if($this->session->userdata('skill_user'))
		{
		   ...
		   $data['course_name']=$this->Category_model->get_course_name_data();
			...
			$this->load->view('admin/header');
			$this->load->view('courseprofiles/courseprofiles',$data);
			$this->load->view('admin/footer');
		}else{
			$this->session->set_flashdata('error',"you don't have permission to access");
			redirect('admin');
	...
	{	
		if($this->session->userdata('skill_user'))
		{
			...
			$data['courese_profile_list']=$this->Category_model->get_courese_profiles_list();	
				//echo'<pre>';print_r($data);exit;
			$this->load->view('admin/header');
			$this->load->view('courseprofiles/courseprofiles-list',$data);
			$this->load->view('admin/footer');
		}else{
			$this->session->set_flashdata('error',"you don't have permission to access");
			redirect('admin');
	...
	{	
		if($this->session->userdata('skill_user'))
		{
			...
			//echo'<pre>';print_r($data);exit;
			$this->load->view('admin/header');
			$this->load->view('courseprofiles/edit-courseprofiles',$data);
			$this->load->view('admin/footer');
		}else{
			$this->session->set_flashdata('error',"you don't have permission to access");
			redirect('admin');
