     ...
     <div class="row">
				 ...
				 <div class="col-md-6">
					...
					<?php if(isset($course_profile_data) && count($course_profile_data)>0){ ?>
	                 ...
	                 <div class="col-md-6">
										<div class="form-group">
											...
											<div class="">
												<input type="text" id="paragraph" name="paragraph" placeholder=" Enter Paragraph" class="form-control" value="<?php echo isset($edit_training_course['paragraph'])?$edit_training_course['paragraph']:''?>">
											</div>
										</div>
									</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label>Title</label>
							<textarea type="text" class="ckeditor" placeholder="Enter Title" name="title"  id="summernote"><?php echo isset($edit_training_course['title'])?$edit_training_course['title']:''?></textarea>
							</div>
						</div>
